...
const Footer = () => {
  return (
    <footer className='max-container'>
        <div className='flex ustify-between items-start gap-20 flex-wrap max-lg:flex-col'>
...
<div key = {Math.random()} className='flex justify-center items-center w-12 h-12 bg-white rounded-full'>
        ...
        <div className=' flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap '>
          {
            footerLinks.map((section)=> {
              ...
              return (
                <div key = {Math.random()}> <h4 className= 'text-white font-montserrat text-2xl leading-normal font-medium mb-6'> {section.title} </h4>
                  <ul>
